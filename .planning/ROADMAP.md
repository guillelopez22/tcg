...
- [ ] **Phase 1: Collection Tracker** - Players can digitize every card they own with full variant, condition, and photo support plus wantlist and tradelist management
...
|-------|----------------|--------|-----------|
| 1. Collection Tracker | 2/5 | In Progress|  |
